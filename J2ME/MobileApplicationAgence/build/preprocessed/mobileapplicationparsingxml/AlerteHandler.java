...
public class AlerteHandler extends DefaultHandler{
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        if (qName.equals("alerte")) {
            ...
            currentPersonne.setPrixMax(Double.parseDouble(attributes.getValue("prixMax")));
            currentPersonne.setPrixMin(Double.parseDouble(attributes.getValue("prixMin")));
            currentPersonne.setRegion(attributes.getValue("region"));
            currentPersonne.setEngagement(attributes.getValue("engagement"));
            currentPersonne.setTypedeBien(attributes.getValue("typedeBien"));
            currentPersonne.setSurface(Double.parseDouble(attributes.getValue("surface")));
            Offre o =new Offre();
